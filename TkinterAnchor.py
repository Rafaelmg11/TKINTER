...
#APÓS TEXTAR COMENTE A LINHA DO LB1 ATE O LB4

lb1.pack(side=LEFT)
lb2.pack(side="left")
lb3.pack(anchor="w") #SEMPRE QUE NÃO UTILIZO A FUNÇÃO SIDE ELE SEMPRE SERÁ TOPO
#lb4.pack(anchor="w") #SEMPRE QUE NÃO UTILIZO A FUNÇÃO SIDE ELE SEMPRE SERÁ TOPO
